...
SWIFT_MODULE_NAMESPACE_PUSH("TableController")

/// A <code>CellControllerType</code> describes something that handles the display of
/// of a single <code>UITableViewCell</code>
SWIFT_CLASS("_TtC15TableController14CellController")
@interface CellController : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


/// A <code>HeaderFooterController</code> describes something that handles the display of
/// of a single <code>UIView</code> that represents a <code>UITableView</code> header or footer.
SWIFT_CLASS("_TtC15TableController22HeaderFooterController")
@interface HeaderFooterController : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


/// A <code>SectionController</code> manages displaying a group of
/// <code>CellControllers</code> in a given section of a <code>UITableView</code>
SWIFT_CLASS("_TtC15TableController17SectionController")
...
SWIFT_CLASS("_TtC15TableController15TableController")
...
@interface TableController (SWIFT_EXTENSION(TableController))
