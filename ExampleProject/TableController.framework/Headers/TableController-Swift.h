...
@interface TableController : NSObject <UIScrollViewDelegate, UITableViewDataSource, UITableViewDelegate>
@property (nonatomic, readonly) NSInteger numberOfSections;
- (void)updateWithCellAt:(NSIndexPath * _Nonnull)indexPath;
- (void)updateWithHeaderInSection:(NSInteger)section;
- (void)updateWithFooterInSection:(NSInteger)section;
...
@interface TableController (SWIFT_EXTENSION(TableController))
- (void)sectionControllerNeedsAnimatedHeightChange;
@end
